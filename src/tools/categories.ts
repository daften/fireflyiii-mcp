...
export function registerCategoryTools(server: McpServer, client: FireflyClient): void {
  ...
  }, ({ page, limit }) => fetchCategories(client, { page: page as number | undefined, limit: limit as number | undefined }));
  ...
  defineTool(server, 'get_category_transactions', {
    ...
    fetchCategoryTransactions(client, categoryId as string, { start: start as string | undefined, end: end as string | undefined, page: page as number | undefined, limit: limit as number | undefined }));
