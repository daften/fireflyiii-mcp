...
export async function updateRecurrence(
  ...
  const hasRepetitionFields =
    params.repeat_type !== undefined ||
    params.repeat_moment !== undefined ||
    params.skip !== undefined ||
    params.weekend !== undefined;
  ...
  const hasTransactionFields =
    ...
    params.transaction_description !== undefined ||
    params.source_id !== undefined ||
    params.destination_id !== undefined ||
...
export async function deleteRecurrence(client: FireflyClient, id: string): Promise<{ deleted: true; id: string }> {
...
export function registerRecurringTools(server: McpServer, client: FireflyClient): void {
  ...
  defineTool(
    ...
    'create_recurring',
    {
      ...
      description:
        'Create a new recurring transaction in Firefly III. Use get_accounts to find source and destination account IDs. Use get_categories to find category IDs.',
      inputSchema: {
        ...
        repeat_until: dateSchema
          .optional()
          .nullable()
          .describe('Stop after this date (YYYY-MM-DD). Omit or pass null for no end date.'),
        nr_of_repetitions: z
          .number()
          .int()
          .positive()
          .optional()
          .describe('Stop after N occurrences. Do not combine with repeat_until.'),
        ...
        repeat_moment: z
          .string()
          .describe(
            'Repetition moment: empty string for daily; 1–7 (Mon–Sun) for weekly; 1–31 for monthly; "week,day" e.g. "2,3" for ndom (2nd Wednesday); YYYY-MM-DD for yearly (year value ignored)',
          ),
        ...
        weekend: z
          ...
          .max(4)
          .optional()
          .describe('Weekend handling: 1=do nothing, 2=skip (no transaction), 3=previous Friday, 4=next Monday'),
    ...
    'update_recurring',
    {
      ...
      inputSchema: {
        ...
        repeat_until: dateSchema
          .optional()
          .nullable()
          .describe('Stop after this date (YYYY-MM-DD). Pass null to remove end date.'),
        ...
        repeat_type: z
          .enum(['daily', 'weekly', 'monthly', 'ndom', 'yearly'])
          .optional()
        ...
        weekend: z
          ...
          .max(4)
          .optional()
          .describe('Weekend handling: 1=do nothing, 2=skip, 3=previous Friday, 4=next Monday'),
